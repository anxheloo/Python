...
#router = routers.SimpleRouter()   #after using filters from django we comment this 3
router.register(r'task',views.TaskViewSet) #we also add views. here after filter | also we add django_filters at settings.py
